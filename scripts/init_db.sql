...
ALTER TABLE BILL_ITEM ADD CONSTRAINT FK_BILL FOREIGN KEY (ID_BILL) REFERENCES BILL(ID);
ALTER TABLE PAYMENTS ADD CONSTRAINT FK_USER FOREIGN KEY (ID_USER) REFERENCES USER(ID);
ALTER TABLE SAMPLE ADD CONSTRAINT FK_TEST_REQUEST FOREIGN KEY (ID_TEST_REQUEST) REFERENCES TEST_REQUEST(ID);
...
ALTER TABLE USER_ROLE ADD CONSTRAINT FK_USER FOREIGN KEY (ID_USER) REFERENCES USE(ID);
