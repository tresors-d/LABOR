...
ALTER TABLE RESULT ADD CONSTRAINT FK_TEST FOREIGN KEY (ID_TEST) REFERENCES TEST (ID);
ALTER TABLE RESULT_ITEM CONSTRAINT FK_RESULT FOREIGN KEY (ID_RESULT) REFERENCES RESULT (ID);
ALTER TABLE BILL_ITEM CONSTRAINT FK_BILL FOREIGN KEY (ID_BILL) REFERENCES BILL(ID);
ALTER TABLE PAYMENTS CONSTRAINT FK_USER FOREIGN KEY (ID_USER) REFERENCES USER(ID);
ALTER TABLE SAMPLE  CONSTRAINT FK_TEST_REQUEST FOREIGN KEY (ID_TEST_REQUEST) REFERENCES TEST_REQUEST (ID);
ALTER TABLE SAMPLE  CONSTRAINT FK_SAMPLE_TYPE FOREIGN KEY (ID_SAMPLE_TYPE) REFERENCES SAMPLE_TYPE, (ID);